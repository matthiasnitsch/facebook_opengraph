	...
	'tx_facebookopengraph_type' => Array (
		...
		'config' => Array (
			...
			'items' => array (
				...
				array('sport', 'sport'),
				array('LLL:EXT:facebook_opengraph/Resources/Private/Language/locallang_db.xml:tx_facebookopengraph_type.div_business', '--div--'),
				array('bar', 'bar'),
				array('company', 'company'),
				array('cafe', 'cafe'),
				array('hotel', 'hotel'),
				array('restaurant', 'restaurant'),
				array('LLL:EXT:facebook_opengraph/Resources/Private/Language/locallang_db.xml:tx_facebookopengraph_type.div_groups', '--div--'),
				array('cause', 'cause'),
				array('sports_league', 'sports_league'),
				array('sports_team', 'sports_team'),
				array('LLL:EXT:facebook_opengraph/Resources/Private/Language/locallang_db.xml:tx_facebookopengraph_type.div_organizations', '--div--'),
				array('band', 'band'),
				array('government', 'government'),
				array('non_profit', 'non_profit'),
				array('school', 'school'),
				array('university', 'university'),
				array('LLL:EXT:facebook_opengraph/Resources/Private/Language/locallang_db.xml:tx_facebookopengraph_type.div_people', '--div--'),
				array('actor', 'actor'),
				...
				array('LLL:EXT:facebook_opengraph/Resources/Private/Language/locallang_db.xml:tx_facebookopengraph_type.div_places', '--div--'),
				array('city', 'city'),
				array('country', 'country'),
				array('landmark', 'landmark'),
				array('state_province', 'state_province'),
				array('LLL:EXT:facebook_opengraph/Resources/Private/Language/locallang_db.xml:tx_facebookopengraph_type.div_entertainment', '--div--'),
				array('album', 'album'),
				array('book', 'book'),
				array('drink', 'drink'),
				array('food', 'food'),
				...
				array('LLL:EXT:facebook_opengraph/Resources/Private/Language/locallang_db.xml:tx_facebookopengraph_type.div_websites', '--div--'),
				array('blog', 'blog'),
